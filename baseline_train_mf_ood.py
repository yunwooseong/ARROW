...
def run_a_trail(train_config,log_file=None, save_mode=False,save_file=None,need_train=True,warm_or_cold=None):
    ...
    data_dir = "/home/minseong/CoLLM/collm-datasets/ml-1m/"
...
#     embedding_size_ = [256]
#     try:
#         f = open("0519ml1m-ood-v2-rec_mf_search_lr"+str(lr_[0])+".log",'rw+')
#     except:
#         f = open("0519ml1m-ood-v2-rec_mf_search_lr"+str(lr_[0])+".log",'w+')
#     for lr in lr_:
#         for wd in dw_:
    ...
    for lr in lr_:
        for wd in dw_:
            for embedding_size in embedding_size_:
                ...
                print(train_config)
                save_path += "0603_ml1m_oodv2_best_model_d" + str(embedding_size)+ 'lr-'+ str(lr) + "wd"+str(wd) + ".pth"
...
#                 }
#                 print(train_config)
#                 # save_path = "/home/minseong/CoLLM/PretrainedModels/mf/0912_ml1m_oodv2_best_model_d256lr-0.001wd0.0001.pth"
#                 save_path = "/home/minseong/CoLLM/PretrainedModels/mf/0603_ml1m_oodv2_best_model_d256lr-0.0001wd0.0001.pth"
#                 # run_a_trail(train_config=train_config, log_file=f, save_mode=False,save_file=save_path,need_train=False,warm_or_cold='warm')  
#                 run_a_trail(train_config=train_config, log_file=f, save_mode=False,save_file=save_path,need_train=False,warm_or_cold=False)
#     if f is not None:
#         f.close()
